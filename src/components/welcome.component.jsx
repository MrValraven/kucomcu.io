...
const Welcome = () => {
  ...
  const connectedWallet = "0x1A0384...6123828";
  const connectWallet = () => {};
  const handleChange = () => {};
  const handleSubmit = () => {};
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <div className="grid sm_grid-cols-3 grid-cols-2 w-full mt-10">
        ...
        <div className="flex flex-col flex-1 items-center mf:mt-0 mt-10">
